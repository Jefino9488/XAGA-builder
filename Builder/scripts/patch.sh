...
if [ -f ${WORKSPACE}/framework_patcher/framework/classes.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/framework/classes.dex -o ${WORKSPACE}/framework_patcher/framework/classes
else
  echo -e "${RED}- classes.dex not found in framework.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/framework/classes2.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/framework/classes2.dex -o ${WORKSPACE}/framework_patcher/framework/classes2
else
  echo -e "${RED}- classes2.dex not found in framework.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/framework/classes3.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/framework/classes3.dex -o ${WORKSPACE}/framework_patcher/framework/classes3
else
  echo -e "${RED}- classes3.dex not found in framework.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/framework/classes4.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/framework/classes4.dex -o ${WORKSPACE}/framework_patcher/framework/classes4
else
  echo -e "${RED}- classes4.dex not found in framework.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/framework/classes5.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/framework/classes5.dex -o ${WORKSPACE}/framework_patcher/framework/classes5
else
...
if [ -f ${WORKSPACE}/framework_patcher/services/classes.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/services/classes.dex -o ${WORKSPACE}/framework_patcher/services/services_classes
else
  echo -e "${RED}- classes.dex not found in services.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/services/classes2.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/services/classes2.dex -o ${WORKSPACE}/framework_patcher/services/services_classes2
else
  echo -e "${RED}- classes2.dex not found in services.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/services/classes3.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/services/classes3.dex -o ${WORKSPACE}/framework_patcher/services/services_classes3
else
  echo -e "${RED}- classes3.dex not found in services.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/services/classes4.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/services/classes4.dex -o ${WORKSPACE}/framework_patcher/services/services_classes4
else
  echo -e "${RED}- classes4.dex not found in services.jar"
fi
if [ -f ${WORKSPACE}/framework_patcher/services/classes5.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/services/classes5.dex -o ${WORKSPACE}/framework_patcher/services/services_classes5
else
...
if [ -f ${WORKSPACE}/framework_patcher/miui_services/classes.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/miui_services/classes.dex -o ${WORKSPACE}/framework_patcher/miui_services/miui_services_classes
else
...
if [ -f ${WORKSPACE}/framework_patcher/miui_framework/classes.dex ]; then
  java -jar "${WORKSPACE}/tools/baksmali.jar" d -a 34 ${WORKSPACE}/framework_patcher/miui_framework/classes.dex -o ${WORKSPACE}/framework_patcher/miui_framework/miui_framework_classes
else
...
if [ -d ${WORKSPACE}/framework_patcher/framework/classes ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/framework/classes -o ${WORKSPACE}/framework_patcher/framework/classes.dex
else
  echo -e "${RED}- classes not found in framework"
fi
if [ -d ${WORKSPACE}/framework_patcher/framework/classes2 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/framework/classes2 -o ${WORKSPACE}/framework_patcher/framework/classes2.dex
else
  echo -e "${RED}- classes2 not found in framework"
fi
if [ -d ${WORKSPACE}/framework_patcher/framework/classes3 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/framework/classes3 -o ${WORKSPACE}/framework_patcher/framework/classes3.dex
else
  echo -e "${RED}- classes3 not found in framework"
fi
if [ -d ${WORKSPACE}/framework_patcher/framework/classes4 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/framework/classes4 -o ${WORKSPACE}/framework_patcher/framework/classes4.dex
else
  echo -e "${RED}- classes4 not found in framework"
fi
if [ -d ${WORKSPACE}/framework_patcher/framework/classes5 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/framework/classes5 -o ${WORKSPACE}/framework_patcher/framework/classes5.dex
else
...
if [ -d ${WORKSPACE}/framework_patcher/services/services_classes ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/services/services_classes -o ${WORKSPACE}/framework_patcher/services/classes.dex
else
  echo -e "${RED}- classes not found in services"
fi
if [ -d ${WORKSPACE}/framework_patcher/services/services_classes2 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/services/services_classes2 -o ${WORKSPACE}/framework_patcher/services/classes2.dex
else
  echo -e "${RED}- classes2 not found in services"
fi
if [ -d ${WORKSPACE}/framework_patcher/services/services_classes3 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/services/services_classes3 -o ${WORKSPACE}/framework_patcher/services/classes3.dex
else
  echo -e "${RED}- classes3 not found in services"
fi
if [ -d ${WORKSPACE}/framework_patcher/services/services_classes4 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/services/services_classes4 -o ${WORKSPACE}/framework_patcher/services/classes4.dex
else
  echo -e "${RED}- classes4 not found in services"
fi
if [ -d ${WORKSPACE}/framework_patcher/services/services_classes5 ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/services/services_classes5 -o ${WORKSPACE}/framework_patcher/services/classes5.dex
else
...
if [ -d ${WORKSPACE}/framework_patcher/miui_services/miui_services_classes ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/miui_services/miui_services_classes -o ${WORKSPACE}/framework_patcher/miui_services/classes.dex
else
...
if [ -d ${WORKSPACE}/framework_patcher/miui_framework/miui_framework_classes ]; then
  java -jar "${WORKSPACE}/tools/smali.jar" a ${WORKSPACE}/framework_patcher/miui_framework/miui_framework_classes -o ${WORKSPACE}/framework_patcher/miui_framework/classes.dex
else
